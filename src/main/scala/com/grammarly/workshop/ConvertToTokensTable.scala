...
object ConvertToTokensTable {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val ds = spark.read.parquet("s3://workshop-lviv/data/ds1/").as[Record]
    ...
    tokens
      ...
      .parquet("s3://workshop-lviv/data/ds3/")
  }
...
case class AnnotatedRecord(uri: String, content: String, document: Array[Annotation], sentence: Array[Annotation], pos: Array[Annotation])

case class TokenRow(uri: String, token: String, posTag: String, tokenStart: Int, tokenEnd: Int, tokenPos: Int, sentenceStart: Int, sentenceEnd: Int, sentencePos: Int, docLength: Int)